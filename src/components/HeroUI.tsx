...
const HeroUI = () => {
    return (
        <section id='home' className='min-h-screen flex flex-col space-y-10 items-center justify-center relative overflow-hidden bg-white dark:bg-black'>
            {/* Content */}
            <div className='flex flex-col items-center space-y-5 max-w-8xl mx-auto px-4'>
                ...
                <p className='text-2xl text-slate-700 dark:text-neutral-100 max-w-5xl text-center'>Full Stack Developer, Data Analyst & AI Enthusiast. I enjoy learning about new technologies and applying them to solve real-world problems.</p>
            </div>
            {/* Buttons */}
            <div className='flex items-center space-x-4'>
                <Button onClick={() => scrollToSection('about')} className='py-2 px-4 bg-gradient-to-r from-blue-500/80 via-blue-400/80 to-violet-600/80 hover:bg-gray-500/70 transition-all duration-300 flex items-center space-x-5 border rounded-md overflow-hidden border-black hover:border-blue-400 text-slate-900'>
