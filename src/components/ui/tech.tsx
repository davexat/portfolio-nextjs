...
import { hoverBorderColor, backgroundColor } from "@/lib/utils";
...
const TechItem = ({ icon, color, text, changeMode } : TechItemProps) => {
    return (
        <li className={clsx('group relative flex flex-col transition-all duration-300 justify-center items-center p-4 border rounded-md border-blue-400/20 hover:shadow-md bg-white dark:bg-slate-900', hoverBorderColor(color))}>
