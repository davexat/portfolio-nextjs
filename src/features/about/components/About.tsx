...
export default function About() {
    return (
        <section id='about' className='base-section'>
            ...
            {/* Content */}
            <div className='flex-center flex-col w-full xl:flex-row max-w-7xl text-xl text-center xl:text-justify gap-5 sm:gap-10'>
                <div className="max-w-xs flex-center overflow-hidden xl:max-w-2/5 xl:pr-15">
                    <span className="shadow-lg rounded-full overflow-hidden xl:rounded-xl xl:max-w-sm items-stretch m-5 sm:m-0">
                        <Image src='/me.jpg' alt='Profile Picture' width={400} height={400} />
                    </span>
                </div>
                <div className="info-text flex flex-col gap-5 w-full xl:max-w-1/2">
