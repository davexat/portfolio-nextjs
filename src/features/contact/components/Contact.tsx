        ...
        <section id='contact' className='layout-section bg-section color-text'>
            ...
            <span className='max-w-7xl lg:max-w-5xl w-full flex flex-col gap-4 lg:flex-row justify-center'>
                ...
                <span className='flex flex-col gap-4 w-full'>
                    ...
                    <p className='opacity-80 text-center'>If you want to meet me in person, we can schedule a meeting from Monday to Thursday at the Facultad de Ingeniería en Electricidad y Computación (FIEC) - ESPOL. Feel free to reach out to coordinate a time!</p>
                </span>
            </span>
        </section>
    )
