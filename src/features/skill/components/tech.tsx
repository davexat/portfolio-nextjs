...
const TechItem = ({ icon, color, text, changeMode } : TechItemProps) => {
    return (
        <li className={clsx('group relative flex flex-col transition-all duration-300 justify-center items-center p-4 border rounded-md border-gray-400/20 hover:shadow-md bg-white dark:bg-zinc-900', hoverBorderColor(color))}>
