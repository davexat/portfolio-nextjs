...
const TechItem = ({ icon, color, text, changeMode } : TechItemProps) => {
    return (
        <li className={clsx('group relative flex flex-col justify-center items-center p-4 border rounded-md border-button bg-button transitions', hoverBorderColor(color), hoverShadowColor(color))}>
